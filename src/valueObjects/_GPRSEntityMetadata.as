...
internal class _GPRSEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("gprsId", "constructionUnit", "technologyType", "manufacturers", "installationSite", "gprsName", "runTime", "projectId", "pperators", "ip", "descp", "typeSpecification", "siteId", "showName", "delFlg", "debugging", "cardNumber");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("gprsId", "constructionUnit", "technologyType", "manufacturers", "installationSite", "gprsName", "runTime", "projectId", "pperators", "ip", "descp", "typeSpecification", "siteId", "showName", "delFlg", "debugging", "cardNumber");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("gprsId", "constructionUnit", "technologyType", "manufacturers", "installationSite", "gprsName", "runTime", "projectId", "pperators", "ip", "descp", "typeSpecification", "siteId", "showName", "delFlg", "debugging", "cardNumber");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("gprsId", "constructionUnit", "technologyType", "manufacturers", "installationSite", "gprsName", "runTime", "projectId", "pperators", "ip", "descp", "typeSpecification", "siteId", "showName", "delFlg", "debugging", "cardNumber");
