 ...
 * of this value object you may modify the generated sub-class of this class - HistoryAlarm.as.
 */
...
[ExcludeClass]
public class _Super_HistoryAlarm extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("cn.com.dhcc.fzep.alarm.data.ustc.vo.HistoryAlarm") == null)
            {
                flash.net.registerClassAlias("cn.com.dhcc.fzep.alarm.data.ustc.vo.HistoryAlarm", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _HistoryAlarmEntityMetadata;
    ...
    public function _Super_HistoryAlarm()
    {
        _model = new _HistoryAlarmEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _HistoryAlarmEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _HistoryAlarmEntityMetadata) : void
    {
        var oldValue : _HistoryAlarmEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
