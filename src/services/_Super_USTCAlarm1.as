...
internal class _Super_USTCAlarm1 extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    public function _Super_USTCAlarm1()
    {
        ...
        valueObjects.AlarmDetail._initRemoteClassAlias();
        valueObjects.USTCAlarm._initRemoteClassAlias();

        var operations:Object = new Object();
        var operation:mx.rpc.remoting.Operation;

        operation = new mx.rpc.remoting.Operation(null, "getAlarm");
         operation.resultElementType = valueObjects.AlarmDetail;
        operations["getAlarm"] = operation;
    ...
    /**
      * This method is a generated wrapper used to call the 'getAlarm' operation. It returns an mx.rpc.AsyncToken whose 
      ...
      */
    public function getAlarm() : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getAlarm");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send() ;
        return _internal_token;
    }
     
    /**
      * This method is a generated wrapper used to call the 'getUSTCAlarm' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
